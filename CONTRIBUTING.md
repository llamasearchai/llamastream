# Contributing to LlamaStream

Thank you for your interest in contributing to LlamaStream! This document provides guidelines and instructions for contributing to this project.
...
There are many ways to contribute to LlamaStream:
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamastream.git
   cd llamastream
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamastream.git
   ```
...
By contributing to LlamaStream, you agree that your contributions will be licensed under the project's MIT License.
